        ...
        <>
            <div className="  w-full  h-screen md:h-[75vh]   flex flex-col  items-center justify-center ">
                ...
                <div className=" flex flex-col items-center justify-center w-full h-full  z-10 text-[white]">
                    ...
                    <p className='w-max h-auto  font-[400] text-[27px] leading-[27px] sm:text-[32px] sm:leading-[32px] md:text-[45px] md:leading-[35px] lg:text-[50px] lg:leading-[45px]  p-0 sm:tracking-[1px] md:tracking-[2px] mb-[35px] sm:mb-[45px] md:mb-12 lg:mb-12'>dasturlash kurslari</p>
