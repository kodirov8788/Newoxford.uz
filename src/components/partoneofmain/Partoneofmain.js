...
import bgvideo from '../../images/bggif.gif'
        ...
        <>
            <div className="  w-full  h-screen md:h-[75vh]   flex flex-col  items-center justify-center  font-sans">
                ...
                <div className="w-full h-full  md:h-[75vh] absolute z-[-1] ">
                    ...
                    <img className='w-full h-full absolute object-cover ' src={bgvideo} alt="" />
                ...
                <div className=" flex flex-col items-center justify-center w-full h-full  z-10 text-[white]">
                    <h1 className='w-max h-auto  font-[700] text-[55px] leading-[55px] sm:text-[70px] sm:leading-[70px] md:text-[100px] md:leading-[90px] lg:text-[110px] lg:leading-[100px]  p-0 tracking-[1px]'>OXFORD</h1>
                    <p className='w-max h-auto  font-[400] text-[27px] leading-[27px] sm:text-[32px] sm:leading-[32px] md:text-[45px] md:leading-[35px] lg:text-[50px] lg:leading-[45px]  p-0 sm:tracking-[1px] md:tracking-[2px] mb-[35px] sm:mb-[45px] md:mb-12 lg:mb-12'>Ingliz tili kurslari</p>
