            ...
            <div className='w-[85%] xl:w-[88%] h-full  m-auto flex justify-between items-center '>
                ...
                <div className=' sm:w-[27%] text-3xl flex justify-between items-center font-sans md:w-[30%] md:text-4xl  xl:w-[85%] '>
                    ...
                    <ul className='hidden  xl:flex  xl:w-[88%]     justify-between  items-center list-none h-[60px]'>
                        <li className='group  h-full flex items-center px-[10px]  hover:bg-[rgb(100, 100, 100)]'><a href="#" className='text-[15px]  uppercase font-sans  flex  items-center'>Kurslar <span className='ml-[5px]'><HiChevronDown /></span></a>
                            ...
                            <div className='  absolute hidden  group-hover:flex z-40  top-[60px] bg-[#212121] text-white w-[80%] right-0 list-none   justify-between py-[20px] px-[20px]'>
                                ...
                                <div className='w-[32%]'>
                                    ...
                                    <li className='w-full pl-[15px] hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">3ds max & autocad</a></li>
                                    <li className='w-full pl-[15px] hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">o'yinlarni yaratish</a></li>
                                    <li className='w-full pl-[15px] hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">kompyuter  yig'ish</a></li>
                                    <li className='w-full pl-[15px] hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">pro foto & Mobilografiya</a></li>

                                </div>

                                <div className='w-[32%]'>
                                    <li className='hover:bg-[rgb(100,100,100)] w-full'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">internet marketing  </a></li>
                                    <li className='hover:bg-[rgb(100,100,100)] w-full'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">python </a></li>
                                    <li className='hover:bg-[rgb(100,100,100)] w-full'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">scratch</a></li>
                                    <li className='hover:bg-[rgb(100,100,100)] w-full'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">blender</a></li>
                                ...
                                <div className='w-[33%]'>
                                    <li className='w-full hover:bg-[rgb(100,100,100)] pl-[15px]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">pro design</a></li>
                                    <li className='w-full hover:bg-[rgb(100,100,100)] pl-[15px]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">motion design & videomontaj </a></li>
                                    <li className='w-full hover:bg-[rgb(100,100,100)] pl-[15px]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">android & ios dasturlash</a></li>
                                    <li className='w-full hover:bg-[rgb(100,100,100)] pl-[15px]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans  py-[7px] mt-[5px]' href="">pro foto & Mobilografiya</a></li>
                        ...
                        <li className='h-full flex items-center group  px-[10px] hover:bg-[rgb(100,100,100)] '>
                            ...
                            <div className='absolute hidden group-hover:block w-[25%] top-[60px] bg-[#212121] px-[10px] ml-[-10px]'>
                                ...
                                <div className=' py-[20px]'>
                                    <li className='w-full hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">amalyot </a></li>
                                    <li className='w-full hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">ish bilan yordam 2.0 </a></li>
                                    <li className='w-full hover:bg-[rgb(100,100,100)]'><a className=' inline-block w-full text-[18px] uppercase font-semibold font-sans indent-4 py-[7px] mt-[5px]' href="">ish beruvchilar uchun
                                    </a></li>
                        ...
                        <li className='h-full flex items-center px-[10px] bg-[rgb(100,100,100)]'><a href="#" className='text-[15px] uppercase font-sans flex'>Qo'ng'iroq qilish</a></li>
                    </ul>
