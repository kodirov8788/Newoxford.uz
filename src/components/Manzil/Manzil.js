...
function Manzil() {
  return (
    <div name="manzil">
      <div>
        <h1 className=" lg:text-5xl xl:text-6xl text-center font-mono font-semibold mt-3">O'quv Markazlarimiz</h1>
      </div>
      <div className="w-[80%] flex justify-center mx-auto my-10">
        <div>
          <h1 className="text-xl font-medium mt-10">1-Filial</h1>
          <p className="w-[90%] text-lg mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam molestiae vero adipisci perferendis, iste eum et voluptates ipsum dolores quaerat! </p>
        </div>
        <div>
          <iframe
