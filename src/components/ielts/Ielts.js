...
function Ielts() {
    return (
        <div className='w-full h-[1400px] md:h-[700px]  flex items-center justify-center'>
            <div className="w-full h-full md:flex">
                ...
                <div className="md:w-[50%]  w-full md:h-full h-[700px] flex items-center justify-center pt-5 pb-5 ">
                    <div className="w-[90%] h-full bg-white shadow-lg border shadow-indigo-500/100 rounded-2xl pt-5 pl-8 pr-8">
                        ...
                        <div className="w-full h-[90px] flex items-center justify-center group duration-1000 mt-10 hover:bg-blue-600 shadow-lg border shadow-indigo-500/100 rounded-2xl">
                            <h1 className='md:text-[50px] text-[40px] text-blue-600 group-hover:text-white duration-1000 hover:text-white'>Elementary</h1>
                        </div>

                        <div className="w-full h-[90px] flex items-center justify-center group duration-1000 mt-10 hover:bg-blue-600 shadow-lg border shadow-indigo-500/100 rounded-2xl">
                            <h1 className='md:text-[50px] text-[32px] text-blue-600 duration-1000 group-hover:text-white hover:text-white'>Pre-Intermediate</h1>
                        </div>
                        ...
                        <div className="w-full h-[90px] flex items-center group justify-center duration-1000 hover:bg-blue-600 mt-10 shadow-lg border shadow-indigo-500/100 rounded-2xl">
                            <h1 className='md:text-[50px] text-[40px] group-hover:text-white duration-1000 text-blue-600 hover:text-white'>Intermediate</h1>
                        </div>
                ...
                <div className="md:w-[50%]  w-full md:h-full h-[700px] flex items-center justify-center pt-5 pb-5 ">
                    <div className="w-[90%] h-full bg-white shadow-lg border shadow-indigo-500/100 rounded-2xl pt-5 pl-8 pr-8">
                        ...
                        <div className="w-full h-[90px] flex items-center justify-center group duration-1000 mt-10 hover:bg-blue-600 shadow-lg border shadow-indigo-500/100 rounded-2xl">
                            <h1 className='md:text-[50px] text-[40px] text-blue-600 duration-1000 group-hover:text-white hover:text-white'>Intensive</h1>
                        </div>

                        <div className="w-full h-[90px] flex items-center group justify-center duration-1000 hover:bg-blue-600 mt-10 shadow-lg border shadow-indigo-500/100 rounded-2xl">
                            <h1 className='md:text-[50px] text-[40px] group-hover:text-white duration-1000 text-blue-600 hover:text-white'>CEFR</h1>
                        </div>
